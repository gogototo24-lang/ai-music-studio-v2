...
class VoiceEngine:
    ...
    async def generate_voice(self, text: str, preset_key="heroine", enable_reverb=True, filename="voice.mp3"):
        ...
        try:
            ...
            if proc.returncode != 0:
                raise RuntimeError(stderr.decode("utf-8", "ignore")[:300] or "Edge TTS 失敗")
